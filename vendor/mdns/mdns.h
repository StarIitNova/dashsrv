...
//! queries parsed.
static inline size_t mdns_socket_listen(int sock, void *buffer, size_t capacity, mdns_record_callback_fn callback,
                                        void *user_data);
...
static inline size_t mdns_discovery_recv(int sock, void *buffer, size_t capacity, mdns_record_callback_fn callback,
                                         void *user_data);
...
static inline int mdns_query_send(int sock, mdns_record_type_t type, const char *name, size_t length, void *buffer,
...
static inline int mdns_multiquery_send(int sock, const mdns_query_t *query, size_t count, void *buffer, size_t capacity,
                                       uint16_t query_id);
...
static inline int mdns_query_answer_unicast(int sock, const void *address, size_t address_size, void *buffer,
...
static inline int mdns_query_answer_multicast(int sock, void *buffer, size_t capacity, mdns_record_t answer,
                                              const mdns_record_t *authority, size_t authority_count,
                                              const mdns_record_t *additional, size_t additional_count);
...
static inline int mdns_announce_multicast(int sock, void *buffer, size_t capacity, mdns_record_t answer,
                                          const mdns_record_t *authority, size_t authority_count,
                                          const mdns_record_t *additional, size_t additional_count);
...
static inline int mdns_goodbye_multicast(int sock, void *buffer, size_t capacity, mdns_record_t answer,
                                         const mdns_record_t *authority, size_t authority_count,
                                         const mdns_record_t *additional, size_t additional_count);
...
static inline int mdns_is_string_ref(uint8_t val) { return (0xC0 == (val & 0xC0)); }
...
static inline int mdns_multicast_send(int sock, const void *buffer, size_t size) {
...
static inline size_t mdns_discovery_recv(int sock, void *buffer, size_t capacity, mdns_record_callback_fn callback,
    ...
    for (i = 0; i < answer_rrs; ++i) {
        ...
        size_t name_offset = offset;
        int is_answer = mdns_string_equal(buffer, data_size, &offset, mdns_services_query, sizeof(mdns_services_query),
                                          &verify_offset);
        ...
        if (is_answer) {
            ...
            if (callback && callback(sock, saddr, addrlen, MDNS_ENTRYTYPE_ANSWER, query_id, rtype, rclass, ttl, buffer,
...
static inline size_t mdns_socket_listen(int sock, void *buffer, size_t capacity, mdns_record_callback_fn callback,
    ...
    for (int iquestion = 0; iquestion < questions; ++iquestion) {
        ...
        ++total_records;
        if (callback && callback(sock, saddr, addrlen, MDNS_ENTRYTYPE_QUESTION, query_id, rtype, rclass, 0, buffer,
                                 data_size, question_offset, length, question_offset, length, user_data))
            return total_records;
    }
...
static inline void *mdns_answer_add_question_unicast(void *buffer, size_t capacity, void *data,
...
static inline void *mdns_answer_add_record_header(void *buffer, size_t capacity, void *data, mdns_record_t record,
                                                  mdns_string_table_t *string_table) {
...
static inline void *mdns_answer_add_record(void *buffer, size_t capacity, void *data, mdns_record_t record,
                                           mdns_string_table_t *string_table) {
...
static inline void mdns_record_update_rclass_ttl(mdns_record_t *record, uint16_t rclass, uint32_t ttl) {
    if (!record->rclass)
...
static inline void *mdns_answer_add_txt_record(void *buffer, size_t capacity, void *data, const mdns_record_t *records,
...
static inline uint16_t mdns_answer_get_record_count(const mdns_record_t *records, size_t record_count) {
...
static inline int mdns_answer_multicast_rclass_ttl(int sock, void *buffer, size_t capacity, mdns_record_t answer,
                                                   const mdns_record_t *authority, size_t authority_count,
                                                   const mdns_record_t *additional, size_t additional_count,
